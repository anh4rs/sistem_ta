            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        List Pengajuan Seminar Mahasiswa
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                if($val['status_pengajuan'] == 3){
                                                    echo '<font style="color:green;">Seminar telah di ACC</font>';
                                                }else{
                                                ?>
                                                <a href="<?=site_url();?>/penjadwalanseminars/tentukan_jadwal/<?=$val['id']?>" title="Detail" class="btn btn-xs btn-info">
