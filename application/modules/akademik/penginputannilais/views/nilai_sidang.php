<div class="content-wrapper">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line">Form Penginputan Nilai Sidang </h1>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Field Penginputan Nilai Sidang
                    </div>
                    <div class="panel-body">
                        <form method="POST" action="<?=site_url();?>/penginputannilais/set_nilai_sidang">
                            <?php
