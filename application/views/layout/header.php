                        ...
                        <div class="navbar-collapse collapse ">
                            <ul id="menu-top" class="nav navbar-nav navbar-right">
                                ...
                                ?>
                                    ...
                                    <li><a href="table.html">Penjadwalan Seminar</a></li>
                                    <li><a href="forms.html">Penjadwalan Sidang</a></li>
                                    <li><a href="login.html">Penginputan Nilai</a></li>
                                <?php
                                }

                                if($jenis_user === "dosen"){
                                ?>
                                    <li><a href="ui.html">Data Bimbingan</a></li>
                                    <li><a href="table.html">Data Pengujian</a></li>
                                <?php
                                }
                                ...
                                ?>
                                    ...
                                    <li><a href="forms.html">Pengajuan Sidang</a></li>
                                    <li><a href="login.html">Nilai</a></li>
                                <?php
                                }
                                ?>
